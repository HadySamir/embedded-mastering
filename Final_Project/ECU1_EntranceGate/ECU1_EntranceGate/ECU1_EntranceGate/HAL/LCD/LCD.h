 ...
 * 
 * @param LCD_Config* pointer to struct @ref ursorType copy_cursorType @ref LCD_SetCursor functions
 */

void LCD_Init(LCD_Config*); 
 ...
 * 
 * @pre use @ref LCD_StoreCustomChar before use this function used only one time for each index
 * @param ptrLCD pointer to your LCD configuration
